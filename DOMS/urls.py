...
urlpatterns = [
    ...
    url(r'^order/storePositions/$', my_order.poi_list, name='poiList'),
    url(r'^order/StoresList/$', my_order.storeList, name='storeList'),
    url(r'^order/newStore/$', my_order.newStore, name='newStore'),
